...
<section class="home-section home-section-rabochie-zony">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 offset-lg-1">
					<h1><span><?php echo get_the_title(); ?></span> на&nbsp;заказ от&nbsp;производителя
				...
				<div class="col-lg-4 px-0">
					<div class="rasschet">
						<h2 class="forma">Рассчитаем точную стоимость рабочей зоны за 15 минут!</h2>
						<p>Опишите рабочую зону своими словами. При возможности прикрепите изображение</p>
						<form method="post" action="<?php echo get_stylesheet_directory_uri(); ?>/mails/get_calculate.php"
							...
							<textarea type="text" rows="3" name="mes" class="form-control"
								placeholder="Например: длина, ширина, материал и т.д."
			...
			<div class="col-md-9">
				...
				<div class="row justify-content-center">
					...
					$args = [
						...
						'numberposts' => 18,
						'posts_per_page' => 18,
						'portfolio-cat' => '025-рабочие-зоны'
					];
	...
	<div class="container"
		...
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<h3 class="text-center">Рассчитаем точную стоимость рабочей зоны за 15 минут!</h3>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="row">
							...
							<div class="col-10">
								<p class="mb-2">Для расчета опишите рабочую зону своими словами. При возможности прикрепите изображение
								</p>
								<form method="post" action="<?php echo get_stylesheet_directory_uri(); ?>/mails/get_calculate.php"
									enctype="multipart/form-data">
									<textarea type="text" rows="3" name="mes" class="form-control"
			...
			<div class="col-md-8 offset-md-2">
				<div class="row">
					<div class="col-lg-6 order-2 order-lg-1">
						<p>Мебельная фабрика <strong>«Гарантшкаф»</strong> вот уже более 14 лет изготавливает шкафы, гардеробные,
							рабочие зоны и другую корпусную мебель. За это время мы научились разбираться в качестве материалов и
							технологий, применяя в своей работе только лучшие из них. Поэтому мы производим прочную и функциональную
							мебель по выгодным ценам.</p>
...
<section id="process">
	<div class="container"
		...
		<div class="row justify-content-center">
			<div class="col-md-9">
				<h2><span>06</span> / Процесс заказа, оплаты и установки рабочей зоны</h2>
				<div class="row">
						...
						<div class="accordion" id="accordionExample">
							<div class="accordion-item">
								<h4 class="accordion-header" id="headingOne">
									<button class="accordion-button collapsed text-uppercase" type="button" data-bs-toggle="collapse"
										...
										требуется на производство и установку рабочей зоны?</button>
								</h4>
								<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
									data-bs-parent="#accordionExample">
									<div class="accordion-body">Мы не обещаем сделать рабочую зоны за день, два, три или даже 5 дней. МЫ
										НЕ ВВОДИМ НАШИХ КЛИЕНТОВ В ЗАБЛУЖДЕНИЕ. ОТ ЗАКАЗА ДО УСТАНОВКИ рабочей зоны В СРЕДНЕМ ПРОХОДИТ 1,5-2
										НЕДЕЛИ, ПОСЛЕ ЧЕГО МЫ ПРИВЕЗЕМ И УСТАНОВИМ рабочую зону ОДНИМ ДНЕМ.</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
									data-bs-parent="#accordionExample">
									<div class="accordion-body">МЫ ДЕЛАЕМ ВСТРОЕННУЮ И КОРПУСНУЮ МЕБЕЛЬ БОЛЕЕ 10 ЛЕТ, ИМЕЕМ СОБСТВЕННОЕ
										ПРОИЗВОДСТВО, КОТОРОЕ ВЫ МОЖЕТЕ ПОСЕТИТЬ, ЧТОБЫ УБЕДИТЬСЯ, ЧТО МЫ САМИ ИЗГОТАВЛИВАЕМ ВСЕ ШКАФЫ, А НЕ
										ПОРУЧАЕМ ЭТО ДРУГИМ, А С ВАС БЕРЕМ ДОПОЛНИТЕЛЬНУЮ НАЦЕНКУ.</div>
								</div>
							</div>
							<div class="accordion-item">
							...
							<div class="accordion-item">
								...
								<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
									data-bs-parent="#accordionExample">
									<div class="accordion-body">МЫ РАБОТАЕМ С ОДНИМИ ИЗ ВЕДУЩИХ ПРОИЗВОДИТЕЛЕЙ, ОБЛАДАЮЩИХ БОЛЬШОЙ
										ПАЛИТРОЙ ЦВЕТОВ И ВЫСОКИМ КАЧЕСТВОМ ЛДСП, ТАКИМИ КАК EGGER, РУССКИЙ ЛАМИНАТ. ПРОФИЛЬ ДЛЯ ДВЕРЕЙ МЫ
							...
							<div class="accordion-item">
								...
								<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
									data-bs-parent="#accordionExample">
									<div class="accordion-body">ПОСЛЕ ЗАМЕРА И ВЫБОРА МАТЕРИАЛОВ ШКАФА МЫ СРАЗУ СКАЖЕМ ВАМ ОКОНЧАТЕЛЬНУЮ
										СТОИМОСТЬ. СТОИМОСТЬ ВКЛЮЧАЕТ В СЕБЯ ИЗГОТОВЛЕНИЕ, ДОСТАВКУ И УСТАНОВКУ. БОЛЬШЕ НИКАКИХ СКРЫТЫХ
										ПЛАТЕЖЕЙ.</div>
								</div>
							</div>
							...
							<div class="accordion-item">
								...
								<div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
									data-bs-parent="#accordionExample">
									<div class="accordion-body">У НАС СОБСТВЕННОЕ ПРОИЗВОДСТВО. ПОЭТОМУ МЫ МОЖЕМ ГАРАНТИРОВАТЬ ОДНИ ИЗ
										САМЫХ НИЗКИХ ЦЕН!</div>
								</div>
							</div>
							<div class="accordion-item">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<ul>
							...
							<li><a href="/rabochie-zony" class="active">Рабочие зоны</a></li>
