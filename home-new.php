			...
			<div class="row g-4">
				...
				<div class="col-12 col-md-6 col-lg-6">
					<a href="/shkafy-cupe" class="works-cat-card">
						<img src="<?php echo $theme_uri; ?>/img/ico/advantage/portfolio-card-1.webp" alt="Шкафы-купе" loading="lazy" />
						<span class="works-cat-card__title">Шкафы-купе</span>
					</a>
				</div>
				<div class="col-12 col-md-6 col-lg-6">
					<a href="/shkafy-raspashnye" class="works-cat-card">
						<img src="<?php echo $theme_uri; ?>/img/ico/advantage/portfolio-card-2.webp" alt="Шкафы распашные" loading="lazy" />
				...
				<div class="col-12 col-md-6 col-lg-4">
					<a href="/dveri-cupe" class="works-cat-card">
						<img src="<?php echo $theme_uri; ?>/img/ico/advantage/portfolio-card-3.webp" alt="Двери-купе" loading="lazy" />
						<span class="works-cat-card__title">Двери-купе</span>
					</a>
				</div>
				<div class="col-12 col-md-6 col-lg-4">
					<a href="/garderobnye" class="works-cat-card">
						<img src="<?php echo $theme_uri; ?>/img/ico/advantage/portfolio-card-4.webp" alt="Гардеробные" loading="lazy" />
						<span class="works-cat-card__title">Гардеробные</span>
					</a>
				</div>
				<div class="col-12 col-md-6 col-lg-4">
					<a href="/rabochie-zony" class="works-cat-card">
						<img src="<?php echo $theme_uri; ?>/img/ico/advantage/portfolio-card-5.webp" alt="Рабочие зоны" loading="lazy" />
