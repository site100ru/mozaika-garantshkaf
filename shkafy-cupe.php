	...
	<div class="container">
		<div class="row">
			<div class="col-lg-7 offset-lg-1">
				<h1><span>Шкафы-купе</span> на&nbsp;заказ от&nbsp;производителя <span><?php echo $location; ?></span></h1>
				<ul class="main-list">
					<li>
						<div class="row">
...
<section class="section-stock">
	<div style="max-width: 1700px; margin: 0 auto; padding-top: 40px; padding-bottom: 50px; border-right: 1px solid rgba(153, 153, 153, 0.9);  border-left: 1px solid rgba(153, 153, 153, 0.9);">
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row justify-content-center" style="padding-top: 60px;">
				...
				<div class="col-12 col-md-6 mb-3 mb-md-0 section-image order-1 order-md-0">
					<div class="single-image-wrapper">
						<div class="approximation img-wrapper position-relative gallery-2691">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/card/action-card.webp" class="d-block w-100 single-product-img rounded-large" loading="lazy" alt="Скидка до 25%. Акция до 30 сентября">
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-md-6 mb-0 section-image order-1 order-md-0">
					<div class="single-image-wrapper">
						<div class="approximation img-wrapper position-relative gallery-2691">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/card/action-card-2.webp" class="d-block w-100 single-product-img rounded-large" loading="lazy" alt="Беспроцентная рассрочка на 1 год. Акция до 30 сентября">
						</div>
					</div>
				</div>
			</div>
...
<div id="galleryModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.9); z-index: 999999999999;">
	<div id="mainGallery" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="99999999999">
		<div class="carousel-indicators">
			<?php foreach ($all_images as $index => $image): ?>
			<button type="button" data-bs-target="#mainGallery" data-bs-slide-to="<?php echo $index; ?>" aria-label="Slide <?php echo $index + 1; ?>"></button>
			<?php endforeach; ?>
		</div>
	...
	<!-- Кнопка закрытия -->
	<button type="button" onclick="closeGallery();" class="btn-close btn-close-white" style="position: fixed; top: 25px; right: 25px; z-index: 99999;"></button>
</div>
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-lg-6 col-xl-4 text-center mb-3 mb-lg-0">
					<div class="d-lg-none section-title-wrapper text-center text-lg-start">
						<h2 class="section-title">Обращение руководителя фабрики</h2>
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/points.svg" alt="Точки" class="img-fluid mb-0" />
					</div>

					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/director.png" alt="Орлов Игорь Львович" class="img-fluid director-photo" />
				</div>
				...
				<div class="col-lg-6 col-xl-5">
					...
					<p class="director-quote">«Мы производим шкафы, гардеробные и другую корпусную мебель с 2011 года. Нам
						нравится наша работа, нравится делать красивые вещи, нравится получать слова благодарности от наших
						клиентов. Приятно, когда твоя работа радует людей.<br><br>Каждому нашему клиенту мы гарантируем:
						качественную и красивую продукцию без наценок посредников и индивидуальный подход.»</p>
					...
					<div class="col-md-7 mb-5 mb-md-0 text-center">
						<div style="width: 100%; height: 800px; overflow: hidden; position: relative;">
							<iframe style="width:100%; height:100%; border:1px solid #e6e6e6;border-radius:8px;box-sizing:border-box"
								src="https://yandex.ru/maps-reviews-widget/43131278671?comments"></iframe>
							<a href="https://yandex.ru/maps/org/garantshkaf/43131278671/" target="_blank"
								style="box-sizing:border-box;text-decoration:none;color:#b3b3b3;font-size:10px;font-family:YS Text,sans-serif;padding:0 20px;position:absolute;bottom:8px;width:100%;text-align:center;left:0;overflow:hidden;text-overflow:ellipsis;display:block;max-height:14px;white-space:nowrap;padding:0 16px;box-sizing:border-box">
								Фабрика «Гарантшкаф» на Яндекс.Картах
							</a>
						</div>
...
<section id="process">
	<div class="container" style=" max-width: 1700px;  padding-top: 80px; padding-bottom: 50px; border-right: 1px solid rgba(153, 153, 153, 0.9);  border-left: 1px solid rgba(153, 153, 153, 0.9);">
		<div class="row justify-content-center">
			...
			<div class="col-md-9">
				<div class="row">
					<div class="col-lg-3 text-center step"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-1.png" class="img-fluid" />
						<p>Звонок или заявка <br />на сайте</p>
					</div>
					<div class="col-lg-3 text-center step"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-2.png" class="img-fluid" />
						<p>Консультация менеджера и выезд замерщика</p>
					</div>
					<div class="col-lg-3 text-center step"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-3.png" class="img-fluid" />
						<p>Замер и выбор <br />материалов</p>
					</div>
					<div class="col-lg-3 text-center"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-4.png" class="img-fluid" />
						<p>Определение окончательной стоимости</p>
					</div>
					<div class="col-lg-3 text-center step"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-5.png" class="img-fluid" />
					...
					<div class="col-lg-3 text-center step"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-6.png" class="img-fluid" />
						<p>Создание и <br />согласование 3D проекта и запуск его в производство</p>
					</div>
					<div class="col-lg-3 text-center step"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-7.png" class="img-fluid" />
						<p>Доставка и установка <br />одним днем</p>
					</div>
					<div class="col-lg-3 text-center"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/step-8.png" class="img-fluid" />
			...
			<div class="col-md-9">
				<div class="row">
						...
						<div class="accordion" id="accordionExample">
							<div class="accordion-item">
								<h4 class="accordion-header" id="headingOne">
									<button class="accordion-button collapsed text-uppercase" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Сколько времени
										требуется на производство и установку шкафа-купе?</button>
								</h4>
								<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
									<div class="accordion-body">Мы не обещаем сделать шкаф-купе за день, два, три или даже 5 дней. Мы не
										вводим наших клиентов в заблуждение. От заказа до установки шкафа в среднем проходит 1,5-2 недели,
										после чего мы привезем и установим шкаф-купе одним днем.</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
									<div class="accordion-body">Мы делаем шкафы-купе и другую корпусную мебель с 2011 года. Имеем
							...
							<div class="accordion-item">
								...
								<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
									<div class="accordion-body">После замера и выбора материалов шкафа-купе мы сразу скажем Вам
					...
					<div class="col-lg-5 offset-lg-1 px-0 text-right order-1 order-lg-2">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/shkaf-kupe-img.jpg" class="img-fluid without-pad" />
					</div>
				</div>
			</div>
		</div>
...
<section class="section-order-1 pt-md-0">
	<div class="container" style="max-width: 1700px; padding-top: 80px; padding-bottom: 80px; border-right: 1px solid rgba(153, 153, 153, 0.9);  border-left: 1px solid rgba(153, 153, 153, 0.9);">
		<div class="row">
			...
			<div class="col-md-8 offset-md-2">
				<div class="row">
					<div class="col-lg-6 text-center"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/question-shkaf.png" class="question-img img-fluid" />
					</div>
					<div class="col-lg-6">
						<div class="row">
							<div class="col-2"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/question.png" class="img-fluid" />
							</div>
							<div class="col-10">
								<p class="mb-2">Для расчета опишите шкаф-купе своими словами. При возможности прикрепите изображение.
								</p>
...
<footer id="footer">
	<div class="container" style="max-width: 1700px; border-right: 1px solid rgba(153, 153, 153, 0.9);  border-left: 1px solid rgba(153, 153, 153, 0.9);">
		<div class="row">
			<div class="col-md-3 offset-md-1"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/logo.png" class="img-fluid logo" />
				...
				<div class="row">
					...
					<div class="col-md-6">
						<ul>
							...
							<li><a href="/shkafy-cupe" class="active">Шкафы-купе</a></li>
