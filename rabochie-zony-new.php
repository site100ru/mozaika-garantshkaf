...
/**
 * Template Name: Рабочие зоны (новая)
...
$hero_bg = $theme_uri . '/img/ico/advantage/hero-rabochie-zony.jpg'; ?>
		...
		<div class="hero__content">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-xl-7 hero__left">
					<h1>
						<span class="hl">Рабочие зоны</span> на&nbsp;заказ от&nbsp;производителя <span class="hl"><?php echo $location; ?></span>
					</h1>
					<ul class="hero__list">
						<li>
				...
				<div class="col-lg-6 col-xl-4 offset-xl-1 hero__form">
					<div class="form">
						<h2 class="form__title">Рассчитаем точную стоимость рабочей зоны за 15 мин!</h2>
						<p class="form__subtitle">Опишите рабочую зону своими словами. При возможности прикрепите изображение</p>
						<form method="post" action="<?php echo $theme_uri; ?>/mails/get_calculate.php" enctype="multipart/form-data">
							...
							<textarea rows="3" name="mes" class="form__field" placeholder="Опишите рабочую зону своими словами, укажите примерные размеры и материалы"></textarea>
...
<section class="crumbs bg">
	<div class="container">
		<nav class="crumbs__nav woocommerce-breadcrumb" itemprop="breadcrumb">
			...
			/ <span>Рабочие зоны на&nbsp;заказ</span>
		</nav>
	</div>
</section>
...
<section class="lead bg">
	<img class="lead__photo" src="<?php echo $theme_uri; ?>/img/ico/advantage/rabochie-zony-lead__photo-2.jpg" alt="" />
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-4 offset-lg-1">
				<div class="lead__form form--light section-title-wrapper">
					<h2 class="section-title">Рассчитаем стоимость рабочей зоны за&nbsp;15&nbsp;минут!</h2>
					<p class="lead__subtitle">Опишите рабочую зону своими словами. При возможности прикрепите изображение</p>
	...
	<img class="lead__photo-mobile" src="<?php echo $theme_uri; ?>/img/ico/advantage/rabochie-zony-lead__photo-mobile-2.jpg" alt="" />
</section>
	...
	<div class="container">
		...
		<div class="row align-items-start">
				...
				<div class="accordion" id="faqAccordion">
					<div class="accordion-item">
						<h4 class="accordion-header" id="faqH1">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC1" aria-expanded="false" aria-controls="faqC1">Сколько времени требуется на производство и установку рабочей зоны?</button>
						</h4>
						<div id="faqC1" class="accordion-collapse collapse" aria-labelledby="faqH1" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Мы не обещаем сделать рабочую зону за день, два, три или даже 5 дней. От заказа до установки в среднем проходит 1,5–2 недели, после чего мы привезём и установим мебель одним днём.</div>
						</div>
					</div>
					<div class="accordion-item">
					...
					<div class="accordion-item">
						...
						<div id="faqC4" class="accordion-collapse collapse" aria-labelledby="faqH4" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Мы работаем с ведущими производителями ЛДСП — EGGER и «Русский ламинат». Столешницы и фурнитуру подбираем из качественных материалов проверенных брендов.</div>
						</div>
					</div>
					<div class="accordion-item">
						<h4 class="accordion-header" id="faqH5">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC5" aria-expanded="false" aria-controls="faqC5">Как я могу узнать точную стоимость будущей рабочей зоны?</button>
						</h4>
			...
			<div class="col-12 col-lg-6 text-center">
				<img class="faq__img" src="<?php echo $theme_uri; ?>/img/ico/advantage/faq__img-rabochie-zony.jpg" alt="Частые вопросы" />
			</div>
		</div>
	</div>
</section>
...
<section class="lead lead-2 bg">
	<img class="lead__photo" src="<?php echo $theme_uri; ?>/img/ico/advantage/rabochie-zony-lead__photo-1.jpg" alt="" />
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-4 offset-lg-1">
				<div class="lead__form form--light section-title-wrapper">
	...
	<img class="lead__photo-mobile" src="<?php echo $theme_uri; ?>/img/ico/advantage/rabochie-zony-lead__photo-mobile-1.jpg" alt="" />
</section>
