    ...
    <div style="max-width: 1700px; margin: 0 auto; padding-top: 80px; padding-bottom: 50px; border-right: 1px solid rgba(153, 153, 153, 0.9);  border-left: 1px solid rgba(153, 153, 153, 0.9); border-radius: 0px !important">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="row">
                        <div class="col text-md-center section-title-wrapper">
                    ...
                    <?php if ($show_button && $query->have_posts()) : ?>
                        <div class="row text-md-center">
                            <div class="col">
                                <a href="<?php echo esc_url($button_link); ?>" type="button" class="btn btn-lg btn-corporate-color-1 btn-danger mt-4">
