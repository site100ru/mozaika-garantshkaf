<section id="quiz" class="quiz-section">
  <div class="container"
    style="max-width: 1700px; padding-top: 40px; padding-bottom: 50px; border-right: 1px solid rgba(153, 153, 153, 0.9);  border-left: 1px solid rgba(153, 153, 153, 0.9);">
    <div class="row justify-content-center">
      <div class="col-md-9">
        <div class="breadcrumbs pb-0">
          <nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
            <a href="/">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/breadcrumbs-ico-corp.svg">
      ...
      <div class="col-md-9" style="padding-top: 60px">
        <div class="section-title-wrapper text-center">
          ...
          <img class="text-center" src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/points.svg" alt="Точки"
            class="img-fluid" />
        </div>
          ...
          <div class="row text-start quiz-question-wrapper">
            ...
            <div class="col-xl-9" id="question-1">
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-1-1">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/1-1.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-1-2">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/1-2.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-1-3">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/1-3.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-1-4">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/1-4.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-1-5">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/1-5.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-1-6">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/1-6.webp"
                        style="width: 100%" />
                    </div>
                  </label>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" id="btn-next-question-1" value="Следующий" class="btn btn-danger"
            ...
            <div class="col-xl-9" id="question-2" style="display: none">
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-2-1">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/2-1.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-2-2">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/2-2.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-2-3">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/2-3.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-2-4">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/2-4.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-2-5">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/2-5.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-2-6">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/2-6.webp"
                        style="width: 100%" />
                    </div>
                  </label>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                  <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="17" aria-valuemin="0"
                    aria-valuemax="100">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" value="Предыдущий" class="btn btn-corporate-color-outline-1"
                    onclick="previousQuostion('question-2');" />
                </div>

                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" id="btn-next-question-2" value="Следующий" class="btn btn-danger"
                    onclick="nextQuostion('question-2');" />
                </div>
              </div>
            </div>
            <!-- /Шаг 2 -->
            ...
            <div class="col-xl-9" id="question-3" style="display: none;">
              ...
              <div class="row quiz-questions-container">
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-3-1">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/3-1.webp"
                        style="width: 100%">
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-3-2">
                    <input type="radio" id="answer-3-2" name="question-3" class="checkbox"
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/3-2.webp"
                        style="width: 100%">
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-3-3">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/3-3.webp"
                        style="width: 100%">
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-3-4">
                    <input type="radio" id="answer-3-4" name="question-3" class="checkbox"
                      value="Комбинированный вариант">
                    <div class="option_inner">
                      <div class="shadow-wrapper">
                        <div class="shadow-wrapper-decoration"></div>
                      </div>
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/3-4.webp"
                        style="width: 100%">
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-3-5">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/3-5.webp"
                        style="width: 100%">
                    </div>
                  </label>
                  <h6 class="quiz-section-h3 mb-4">Пока не знаю</h6>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" value="Предыдущий" class="btn btn-corporate-color-outline-1"
                    onclick="previousQuostion('question-3');" />
                </div>

                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" id="btn-next-question-3" value="Следующий" class="btn btn-danger"
                    onclick="nextQuostion('question-3');" />
                </div>
              </div>
            </div>
            <!-- /Шаг 3 -->
            ...
            <div class="col-xl-9" id="question-4" style="display: none">
              <h3 class="quiz-section-subtitle mb-4 text-start"><span>4/5</span> Какая ориентировочная ширина шкафа
                планируется?</h3>
                  ...
                  <label class="d-flex quiz-chek gap-3" for="answer-4-1">
                    <div class="option_item">
                      ...
                      <div class="option_inner text-start">
                        ...
                        <img loading="lazy"
                          src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                      </div>
                    </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                  <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="38" aria-valuemin="0"
                    aria-valuemax="100">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" id="btn-next-question-4" value="Следующий" class="btn btn-danger"
            ...
            <div class="col-xl-9" id="question-5" style="display: none">
              <h3 class="quiz-section-subtitle mb-4 text-start"><span>5/5</span> Какое количество дверей Вы
                предполагаете?</h3>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-5-1">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/5-1.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-5-2">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/5-2.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-5-3">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/5-3.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-5-4">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/5-4.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-5-5">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/5-5.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-5-6">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/5-6.webp"
                        style="width: 100%" />
                    </div>
                  </label>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                  <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="51" aria-valuemin="0"
                    aria-valuemax="100">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" id="btn-next-question-5" value="Следующий" class="btn btn-danger"
            ...
            <div class="col-xl-9" id="question-6" style="display: none">
              <h3 class="quiz-section-subtitle mb-4 text-start">Какой подарок Вы хотели бы получить в случае заказа?
              </h3>

              <div class="row quiz-questions-container">
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-6-1">
                    <input type="radio" id="answer-6-1" name="question-6" class="checkbox"
                      value="Беспроцентная рассрочка на 1 год" />
                    <div class="option_inner">
                      <div class="shadow-wrapper">
                        <div class="shadow-wrapper-decoration"></div>
                      </div>
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/6-1.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-6-2">
                    ...
                    <div class="option_inner">
                      ...
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/6-2.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-6-3">
                    <input type="radio" id="answer-6-3" name="question-6" class="checkbox"
                      value="Скидка 35% на второй предмет" />
                    <div class="option_inner">
                      <div class="shadow-wrapper">
                        <div class="shadow-wrapper-decoration"></div>
                      </div>
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/6-3.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                ...
                <div class="col-6 col-sm-4 col-xl-3">
                  <label class="option_item mb-3" for="answer-6-4">
                    <input type="radio" id="answer-6-4" name="question-6" class="checkbox"
                      value="Скидка 50% на натяжной потолок" />
                    <div class="option_inner">
                      <div class="shadow-wrapper">
                        <div class="shadow-wrapper-decoration"></div>
                      </div>
                      <img loading="lazy"
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/6-4.webp"
                        style="width: 100%" />
                    </div>
                  </label>
                  <h6 class="quiz-section-h3 mb-4">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                  <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="68" aria-valuemin="0"
                    aria-valuemax="100">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" id="btn-next-question-6" value="Следующий" class="btn btn-danger"
                ...
                <div class="row quiz-questions-container align-items-center">
                  <div class="col-6 col-sm-4 col-md-6 col-xl-3 mb-3">
                    <label class="option_item" for="answer-7-1">
                      <div class="d-flex quiz-chek gap-2 align-items-center ">
                        <input type="checkbox" id="answer-7-1" name="answer-7-1" class="checkbox" value="Перезвонить" />
                        <div class="option_inner text-start">
                          <div class="shadow-wrapper-box"></div>
                          <img loading="lazy"
                            src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                        ...
                        <img
                          src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/messengers-icons.svg"
                          class="qize-feedback-icons">
                  ...
                  <div class="col-6 col-sm-4 col-md-6 col-xl-3 mb-3">
                    <label class="option_item" for="answer-7-2">
                      <div class="d-flex quiz-chek gap-2 align-items-center">
                        <input type="checkbox" id="answer-7-2" name="answer-7-2" class="checkbox"
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/wa-icons.svg"
                          class="qize-feedback-icons">
                  ...
                  <div class="col-6 col-sm-4 col-md-6 col-xl-3 mb-3">
                    <label class="option_item" for="answer-7-3">
                      <div class="d-flex quiz-chek gap-2 align-items-center">
                        <input type="checkbox" id="answer-7-3" name="answer-7-3" class="checkbox"
                        ...
                        <img
                          src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/telegram-icons.svg"
                          class="qize-feedback-icons">
                  ...
                  <div class="col-6 col-sm-4 col-md-6 col-xl-3 mb-3">
                    <label class="option_item" for="answer-7-4">
                      <div class="d-flex quiz-chek gap-2 align-items-center">
                        <input type="checkbox" id="answer-7-4" name="answer-7-4" class="checkbox"
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/max-icons.svg"
                          class="qize-feedback-icons">
                  ...
                  <div class="col-12 col-md-6 col-xl-3 mt-4">
                    ...
                    <div>
                      <input type="text" class="form-control telMask" id="feedback-phone" name="form-phone"
                        placeholder="Ваш телефон" inputmode="text" required="" />
                    </div>
                  </div>
              ...
              <div class="row justify-content-center">
                <div class="col pt-5 text-center text-xl-start">
                  ...
                  <div class="img-fluid mb-2 w-100 img-director mt-3">
                    <img loading="lazy"
                      src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/director-img.jpg" />
                  </div>
                  ...
                  <div class="d-flex flex-column align-items-center align-items-lg-start">
                    <a href="tel:+79856445775" class="d-flex aling-items-center tel">
                      <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/mobile-phone-ico.svg">
                      8 (985) 644-57-75
                    </a>
