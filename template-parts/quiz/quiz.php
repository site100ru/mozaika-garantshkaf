        ...
        <div class="quiz-question-container">
          <div class="row text-start quiz-question-wrapper">
            ...
            <div class="col-xl-9" id="question-2">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-0">
                  <input type="button" disabled value="Предыдущий" class="btn btn-corporate-color-outline-1"
            ...
            <div class="col-xl-9" id="question-4" style="display: none">
              <h3 class="quiz-section-subtitle mb-4 text-start"><span>3/5</span> Какая ориентировочная ширина шкафа
                планируется?</h3>
            ...
            <div class="col-xl-9" id="question-5" style="display: none">
              <h3 class="quiz-section-subtitle mb-4 text-start"><span>4/5</span> Какое количество дверей Вы
                предполагаете?</h3>
            ...
            <div class="col-xl-9" id="question-6" style="display: none">
              <h3 class="quiz-section-subtitle mb-4 text-start"><span>5/5</span> Какой подарок Вы хотели бы получить в
                случае заказа?</h3>
