...
<section class="section-testimonials <?php echo esc_attr($bg_color); ?>">
    <div class="container"
            ...
            <div class="col-md-9">
                <div class="col text-md-center pb-4">
                    ...
                    <div class="review-rating mb-3 d-flex align-items-md-end justify-content-md-center gap-4 align-items-center">
                        <div>
                            <i class="star-filled">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/star.svg" alt="stars">
                            </i>
                            <i class="star-filled">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/star.svg" alt="stars">
                            </i>
            ...
            <div class="col-md-9 gap-3 gap-lg-0 gap-xl-3 d-flex flex-wrap flex-xl-nowrap mx-auto">
                    ...
                    <div class="review-card rounded h-100">
                        ...
                        <div class="review-header d-flex align-items-center mb-3">
                            <div class="review-photo me-3">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/icon-1.png"
                                    alt="Maxyz Nikolaevich" class="rounded-circle" width="50" height="50">
                            </div>
                ...
                <div class="col-12 col-lg-6 col-xl-4 mb-4">
                    <div class="review-card rounded h-100">
                        ...
                        <div class="review-header d-flex align-items-center mb-3">
                            <div class="review-photo me-3">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/icon-3.png"
                                    alt="Наталья В." class="rounded-circle" width="50" height="50">
                            </div>
                            <div class="review-info">
        ...
        <div class="row text-center mt-4">
            <div class="col">
                <a href="https://yandex.kz/maps/org/garantshkaf/43131278671/?ll=37.475504%2C56.017226&z=17" target="_blank" class="btn btn-danger px-4 mx-3 reviews-btn">Все
                    отзывы</a>
            </div>
        </div>
    </div>
