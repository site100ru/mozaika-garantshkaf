...
<!-- Home section -->
<div id="sp-home scroll"></div>
<section class="home-section home-section-garderobnye">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 px-0">
					<div class="rasschet">
						<h2 class="forma">Рассчитаем точную стоимость гардеробной за 15 минут!</h2>
						<p>Опишите гардеробную своими словами. При возможности прикрепите изображение</p>
	...
	<div class="container"
		...
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<h3 class="text-center">Рассчитаем точную стоимость гардеробной за 15 минут!</h3>
			...
			<div class="col-md-8 offset-md-2">
				<div class="row">
					<div class="col-lg-6 order-2 order-lg-1">
						<p>Мебельная фабрика <strong>«Гарантшкаф»</strong> вот уже более 14 лет изготавливает гардеробные и другую
							...
							<div class="accordion-item">
								...
								<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
									...
									<div class="accordion-body">Мы не обещаем сделать шкаф-купе за день, два, три или даже 5 дней. МЫ НЕ
										...
										ПОСЛЕ ЧЕГО МЫ ПРИВЕЗЕМ И УСТАНОВИМ ШКАФ ОДНИМ ДНЕМ.</div>
								</div>
							</div>
							<div class="accordion-item">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="row">
							...
							<div class="col-10">
								<p class="mb-2">Для расчета опишите гардеробную своими словами. При возможности прикрепите изображение.
								</p>
								<form method="post" action="<?php echo get_stylesheet_directory_uri(); ?>/mails/get_calculate.php"
									enctype="multipart/form-data">
									<textarea type="text" rows="3" name="mes" class="form-control"
				...
				<div class="row">
					...
					<div class="col-md-6">
						<ul>
							...
							<li><a href="/garderobnye" class="active">Гардеробные</a></li>
