            ...
            <div class="col">
                <div class="breadcrumbs">
                    <nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
                        <a href="/"><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/breadcrumbs-ico.svg"></a> / <a
                            href="#">Наши работы</a>
                    </nav>
                </div>
            </div>
            ...
            <div class="col">
                <div class="row">
                    <div class="col text-center">
                        ...
                        <svg class="mb-5" width="62" height="14" viewBox="0 0 62 14" fill="none"
                            ...
                            <ul class="nav justify-content-md-center d-flex m-auto">
                                ...
                                foreach ($terms as $term) { ?>
                                    <li class="nav-item d-none d-xl-inline"><span class="nav-link px-0"><img
                                                ...
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/menu-decoration.svg"
                                                alt=""></span></li>
