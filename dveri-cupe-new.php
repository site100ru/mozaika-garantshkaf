...
/**
 * Template Name: Двери-купе (новая)
		...
		<div class="hero__content">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-xl-7 hero__left">
					<h1>
						<span class="hl">Двери-купе</span> на&nbsp;заказ от&nbsp;производителя <span class="hl"><?php echo $location; ?></span>
					</h1>
					<ul class="hero__list">
						<li>
				...
				<div class="col-lg-6 col-xl-4 offset-xl-1 hero__form">
					<div class="form">
						<h2 class="form__title">Рассчитаем точную стоимость дверей-купе за 15 мин!</h2>
						<p class="form__subtitle">Опишите двери-купе своими словами. При возможности прикрепите изображение</p>
						<form method="post" action="<?php echo $theme_uri; ?>/mails/get_calculate.php" enctype="multipart/form-data">
							...
							<textarea rows="3" name="mes" class="form__field" placeholder="Опишите двери-купе своими словами, укажите примерные размеры и материалы"></textarea>
		...
		<div class="row">
			<div class="col-12 col-lg-4 offset-lg-1">
				<div class="lead__form form--light section-title-wrapper">
					<h2 class="section-title">Рассчитаем стоимость дверей-купе за&nbsp;15&nbsp;минут!</h2>
					<p class="lead__subtitle">Опишите двери-купе своими словами. При возможности прикрепите изображение</p>
		...
		<div class="row justify-content-around">
			...
			<div class="col-md-6 col-lg-3">
				<div class="howto-step">
					...
					<p class="howto-step__text">Если Вас всё устраивает, мы приезжаем к Вам на замер, утверждаем сроки, материалы, заключаем договор. Только здесь Вы вносите предоплату 30%, и двери-купе поступают в производство.</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="howto-step mb-0">
					...
					<p class="howto-step__text">После окончания производства доставляем и устанавливаем двери-купе в заранее оговорённые дату и время. После установки производим окончательные расчёты. Убираем весь мусор.</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="accordion" id="faqAccordion">
					<div class="accordion-item">
						<h4 class="accordion-header" id="faqH1">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC1" aria-expanded="false" aria-controls="faqC1">Сколько времени требуется на производство и установку дверей-купе?</button>
						</h4>
						<div id="faqC1" class="accordion-collapse collapse" aria-labelledby="faqH1" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Мы не обещаем сделать двери-купе за день, два, три или даже 5 дней. От заказа до установки в среднем проходит 1,5–2 недели, после чего мы привезём и установим двери-купе одним днём.</div>
						</div>
					</div>
					<div class="accordion-item">
						...
						<div id="faqC2" class="accordion-collapse collapse" aria-labelledby="faqH2" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Мы делаем двери-купе и другую корпусную мебель с 2011 года. Имеем собственное производство, которое Вы можете посетить, чтобы убедиться, что мы сами изготавливаем всю продукцию, а не поручаем это другим, а с вас берём дополнительную наценку.</div>
						</div>
					</div>
					<div class="accordion-item">
						<h4 class="accordion-header" id="faqH3">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC3" aria-expanded="false" aria-controls="faqC3">Как выбрать наполнение и дизайн дверей-купе?</button>
						</h4>
						<div id="faqC3" class="accordion-collapse collapse" aria-labelledby="faqH3" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Наши замерщики помогут Вам с выбором материалов и наполнения дверей-купе с учётом Ваших пожеланий и конструктивных возможностей помещения.</div>
						</div>
					</div>
					<div class="accordion-item">
						...
						<div id="faqC4" class="accordion-collapse collapse" aria-labelledby="faqH4" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Профиль для дверей-купе используем Aristo, Italum и Inlux. Заполнение — ЛДСП, зеркало, стекло с плёнкой или фотопечатью на выбор.</div>
						</div>
					</div>
					<div class="accordion-item">
						<h4 class="accordion-header" id="faqH5">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC5" aria-expanded="false" aria-controls="faqC5">Как я могу узнать точную стоимость будущих дверей-купе?</button>
						</h4>
