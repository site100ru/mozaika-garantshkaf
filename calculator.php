			...
			<div class="col py-5">
				...
				<div class="row pb-2 align-items-center advantage-section mb-3 mb-xl-5">
					<div class="col-md-6 col-xl-3 mb-3 mb-xl-0">
						<div class="row align-items-center">
							<div class="col-2 col-xl-3">
								<img class="w-100" style="max-width: 60px" src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/home-advantage-1.svg">
							</div>
					...
					<div class="col-md-6 col-xl-3 mb-3 mb-xl-0">
						<div class="row align-items-center">
							<div class="col-2 col-xl-3">
								<img class="w-100" style="max-width: 60px" src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/home-advantage-2.svg">
							</div>
							<div class="col-10 col-md-9">
					...
					<div class="col-md-6 col-xl-3 mb-3 mb-xl-0">
						<div class="row align-items-center">
							<div class="col-2 col-xl-3">
								<img class="w-100" style="max-width: 60px" src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/home-advantage-3.svg">
							</div>
							<div class="col-10 col-md-9">
					...
					<div class="col-md-6 col-xl-3  mb-3 mb-xl-0">
						<div class="row align-items-center">
							<div class="col-2 col-xl-3">
								<img class="w-100" style="max-width: 60px" src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/home-advantage-4.svg">
							</div>
							<div class="col-10 col-md-9">
				...
				<button type="button" class="btn btn-danger calculate-btn mb-3" data-bs-toggle="modal" data-bs-target="#want-this">Рассчитать стоимость
					<!--дизайнера-->
				</button>
			</div>
		</div>
