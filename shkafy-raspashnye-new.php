...
/**
 * Template Name: Шкафы распашные (новая)
...
$hero_bg = $theme_uri . '/img/ico/advantage/hero-shkafy-raspashnye.jpg'; ?>
		...
		<div class="hero__content">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-xl-7 hero__left">
					<h1>
						<span class="hl">Распашные шкафы</span> на&nbsp;заказ от&nbsp;производителя <span class="hl"><?php echo $location; ?></span>
					</h1>
					<ul class="hero__list">
						<li>
				...
				<div class="col-lg-6 col-xl-4 offset-xl-1 hero__form">
					<div class="form">
						<h2 class="form__title">Рассчитаем точную стоимость распашного шкафа за 15 мин!</h2>
						<p class="form__subtitle">Опишите распашной шкаф своими словами. При возможности прикрепите изображение</p>
				...
				<div class="accordion" id="faqAccordion">
					<div class="accordion-item">
						<h4 class="accordion-header" id="faqH1">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC1" aria-expanded="false" aria-controls="faqC1">Сколько времени требуется на производство и установку распашного шкафа?</button>
						</h4>
						<div id="faqC1" class="accordion-collapse collapse" aria-labelledby="faqH1" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Мы не обещаем сделать распашной шкаф за день, два, три или даже 5 дней. От заказа до установки в среднем проходит 1,5–2 недели, после чего мы привезём и установим шкаф одним днём.</div>
						</div>
					</div>
					<div class="accordion-item">
					...
					<div class="accordion-item">
						...
						<div id="faqC4" class="accordion-collapse collapse" aria-labelledby="faqH4" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Мы работаем с ведущими производителями ЛДСП — EGGER и «Русский ламинат». Для фасадов используем качественную фурнитуру и комплектующие проверенных брендов.</div>
						</div>
					</div>
					<div class="accordion-item">
