...
/**
 * Template Name: Архив портфолио по категориям (новая)
 * Template Post Type: portfolio
 *
 * Шаблон страниц таксономии `portfolio-cat` — выводит работы текущей категории.
 */
...
$current_name = $current_term->name ?? 'Наши работы';
?>
