                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto align-items-center top-navbar">
                                ...
                                <a class="nav-link text-dark" href="archive-product-portfolio.html#">
                                    <div class="d-flex nav-link-inner">
                                        <div class="nav-li-float-left">
                                            <img
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/location-ico.svg" />
                                        </div>
                            ...
                            <li class="nav-item me-3">
                                <a class="nav-link text-dark" href="archive-product-portfolio.html#">
                                    <div class="d-flex nav-link-inner">
                                        <div class="nav-li-float-left">
                                            <img
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/clock-ico.svg" />
                                        </div>
                            ...
                            <li class="nav-item me-3">
                                <a href="archive-product-portfolio.html#" class="nav-link text-dark"
                                    data-bs-toggle="modal" data-bs-target="#callback">
                                    <div class="d-flex nav-link-inner">
                                        <div class="nav-li-float-left">
                                            <img
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/callback-ico.svg" />
                                        </div>
                                        <div class="nav-li-float-right">
                                            Обратный звонок
                                        </div>
                            ...
                            <li class="nav-item me-4">
                                <a class="top-menu-tel nav-link text-dark" href="tel:89856445775">
                                    <div class="d-flex nav-link-inner">
                                        <div class="nav-li-float-left">
                                            <img
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/mobile-phone-ico.svg" />
                                        </div>
			...
			<div class="col">
				<div class="breadcrumbs">
					<nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
						<a href="/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/breadcrumbs-ico.svg"></a> / <a
							href="#">Наши работы</a>
					</nav>
				</div>
			</div>
				...
				<div class="row">
					<div class="col text-center mb-4 mb-md-5">
						<div class="nav-scroller mb-0"
							...
							<ul class="nav justify-content-md-center d-flex m-auto">
								...
								foreach ($terms as $term) { ?>
									<li class="nav-item d-none d-xl-inline"><span class="nav-link px-0"><img style="margin-bottom: 5px;"
												src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/menu-decoration.svg" alt=""></span></li>
									<li class="nav-item">
						...
						<div class="d-md-none text-center mb-4">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/left-right-finger.svg"
